...
export class RestaurantSeed {
  ...
  private restaurants = [
    {
      ...
      image:
        'https://pandokyerevan.com/application/themes/frontend/default/img_corp/khorenatsi1.jpg',
      averageRate: 1,
      rateCount: 2,
    },
    {
      ...
      image:
        'https://dynamic-media-cdn.tripadvisor.com/media/photo-o/1d/54/5d/91/florence-restaurant.jpg?w=800&h=600&s=1',
      averageRate: 2,
      rateCount: 2,
    },
    {
      ...
      image:
        'https://cdn.tasteatlas.com/images/restaurants/5bdfdf1b419146b7a8d3920edebf97c7.jpg?w=600&h=450',
      averageRate: 3,
      rateCount: 2,
    },
    {
      ...
      image:
        'https://cf.bstatic.com/xdata/images/hotel/max1280x900/321346034.jpg?k=da06a39294a5b8fb88ef7f7e3e802357ca2977bc9c4ebef52b93ec7cdb7aedc5&o=&hp=1',
      averageRate: 4,
      rateCount: 2,
    },
    {
      ...
      image:
        'https://old.yerkirmedia.am/wp-content/uploads/2018/09/ibiza-1.jpg',
      averageRate: 5,
      rateCount: 2,
    },
    {
      ...
      image:
        'https://www.tshaurma.com/bitrix/templates/tumanyan/images/buffet/tumanyan/5.jpg',
      averageRate: 1,
      rateCount: 2,
    },
    {
      ...
      image:
        'https://lh5.googleusercontent.com/p/AF1QipMp1xi_kI98Ie1LI0frU6squcekRsQKMPSOB3uQ=w426-h240-k-no',
      averageRate: 2,
      rateCount: 2,
    },
    {
      ...
      image:
        'https://lh5.googleusercontent.com/p/AF1QipO80hYPxDSABsR1djh63-esAjQIqnip5iVghXzh=w408-h271-k-no',
      averageRate: 3,
      rateCount: 2,
    },
    {
      ...
      image:
        'https://lh5.googleusercontent.com/p/AF1QipOUgwMOyb-lvHYankm36h9QpSMgqu1mArGxFlJH=w408-h544-k-no',
      averageRate: 4,
      rateCount: 2,
    },
    {
      ...
      image:
        'https://lh5.googleusercontent.com/p/AF1QipOidw0IAhBbpP1Opc50QFZQUmZjTffJdvhOK98S=w649-h240-k-no',
      averageRate: 5,
      rateCount: 2,
    },
  ];
  ...
  public async add() {
    const rests: RestaurantEntity[] = [];
    for (const r of this.restaurants) {
      rests.push(this.restaurantRepository.create(r));
    }

    await this.restaurantRepository.save(rests);
    const rates: RestaurantRateEntity[] = this.getRates(rests);
    const comments: CommentEntity[] = this.getComments(rests);

    await this.restaurantRateRepository.save(rates);
    await this.commentRepository.save(comments);
  }

  private getRates(rests: RestaurantEntity[]): RestaurantRateEntity[] {
    const rates: RestaurantRateEntity[] = [
  ...
  private getComments(rests: RestaurantEntity[]): CommentEntity[] {
